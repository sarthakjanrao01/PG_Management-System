...
const PgCanceledBooking: React.FC = () => {
    ...
    const getBookings = async () => {
      try {
        ...
        const filteredPgBookings = data.filter(
          (pgbooking: PgBookingModel) => pgbooking.status === "Canceled"
        );
  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex justify-between items-center border-b pb-4 mb-4">
        <h2 className="text-2xl font-bold text-blue-500">Canceled Pg Booking</h2>
      </div>
...
export default PgCanceledBooking;
